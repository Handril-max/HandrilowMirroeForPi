...
####################################################
    ...
    ser_tip = tk.Label(search,text="键入文字内容以搜索",bg=sear_bg,fg='#778899',font=(None,9))
...
####################################################
    ...
    powe1 = tk.Label(f_top_r, text='font=(等线 ,10)', fg=A2, width=None, height=None,
                     bd=0, bg=A5, font=(font, fontsize), activeforeground='#F0F0F0')
...
###################################################
    ...
    powe2 = tk.Label(f_top_r, text='font=(等线 ,10)', bg=A5, fg='#000000',
