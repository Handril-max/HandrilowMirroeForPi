...
class Application(Tk):
    ...
    def __init__(self,my_mode_num=9):
        ...
        self.photoW=ImageTk.PhotoImage(file = ".\H_icon\W.ico")
        self.photoB=ImageTk.PhotoImage(file = ".\H_icon\B.ico")
        self.photoBD=ImageTk.PhotoImage(file = ".\H_icon\BD.ico")
        self.photoWD=ImageTk.PhotoImage(file = ".\H_icon\WD.ico")
        self.photoBU=ImageTk.PhotoImage(file = ".\H_icon\BU.ico")
        self.photoWU=ImageTk.PhotoImage(file = ".\H_icon\WU.ico")
        # 用于黑白棋子图片切换的列表
